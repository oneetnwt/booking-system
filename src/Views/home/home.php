        ...
        <div class="container">
            <div class="hero-content">
                ...
                <p style=" width: 90%;"">Experience a blend of unparalleled hospitality with serene natural beauty
                        ...
                        Spring
                        Resort.</p>
                        <a href="/accommodation" class="btn btn-primary">Book Now</a>
    ...
    <section class="accommodations">
        <div class="container">
            <div class="section-header">
                <h2>Accommodation</h2>
                <a href="/accommodation" class="btn">See All →</a>
            </div>
                ...
                <?php foreach ($accommodations as $accommodation): ?>
                    <div class="room-card">
                        ...
                        <div class="room-content">
                            ...
                            <a href="/booking/confirmation?room_id=<?= $accommodation['id']; ?>" class="btn btn-primary"
    ...
    <section class="testimonials">
        <div class="container">
            <div class="section-header">
                ...
                <a href="/reviews" class="btn">See All →</a>
            </div>
